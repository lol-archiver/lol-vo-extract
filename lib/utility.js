...
import { crc32 as crc } from 'node:zlib';
...
export const showID = (number, fillString = '.') => { return `${String(number).padStart(10, fillString)}|${toHexL8(number)}`; };
